...
class RRT{
public:
    RRT(Vector2d _start, Vector2d _goal, vector<vector<double>>& obs, vector<vector<bool>>& obstacle_map_,Vector2d rand_area,
        double expand = 3, double goal_sample = 0.2, int _max_iter = 20000,
